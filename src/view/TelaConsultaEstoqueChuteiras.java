...
public class TelaConsultaEstoqueChuteiras extends javax.swing.JFrame {
    ...
    public TelaConsultaEstoqueChuteiras() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        TabelaConsultaChuteiras = new javax.swing.JTable();
        ...
        PalavraChaveLabel.setText("Informe marca: ");
        ...
        TabelaConsultaChuteiras.setFont(new java.awt.Font("Work Sans Medium", 0, 18)); // NOI18N
        TabelaConsultaChuteiras.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Etiqueta", "Modelo", "Cor", "Marca", "Tamanho", "Valor (R$)"
            }
        ) {
        ...
        jScrollPane1.setViewportView(TabelaConsultaChuteiras);
    ...
    private void BotaoPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoPesquisarActionPerformed
        String marca = JTFPalavraChave.getText();
        DefaultTableModel tableModel = (DefaultTableModel) TabelaConsultaChuteiras.getModel();
        tableModel.setRowCount(0);
        ChuteiraController chuteiraController = new ChuteiraController();
        
        try {
            
            ArrayList<Chuteira> chuteiras = chuteiraController.listarChuteiras(marca);
            chuteiras.forEach((Chuteira chuteira) -> {
                tableModel.addRow(new Object[]{chuteira.getEtiquetaChuteira(),
                                               chuteira.getModelo(),
                                               chuteira.getCor(),
                                               chuteira.getMarca(),
                                               chuteira.getTamanho(),
            ...
            TabelaConsultaChuteiras.setModel(tableModel);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultaEstoqueChuteiras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaConsultaEstoqueChuteiras().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable TabelaConsultaChuteiras;
