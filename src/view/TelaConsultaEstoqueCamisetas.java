...
public class TelaConsultaEstoqueCamisetas extends javax.swing.JFrame {
    ...
    public TelaConsultaEstoqueCamisetas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        TabelaConsultaCamisetas = new javax.swing.JTable();
        ...
        PalavraChaveLabel.setText("Informe time: ");
        ...
        TabelaConsultaCamisetas.setFont(new java.awt.Font("Work Sans Medium", 0, 18)); // NOI18N
        TabelaConsultaCamisetas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Etiqueta", "Time", "Modelo", "Tamanho", "Valor (R$)"
            }
        ) {
        ...
        jScrollPane1.setViewportView(TabelaConsultaCamisetas);
    ...
    private void BotaoPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoPesquisarActionPerformed
        String time = JTFPalavraChave.getText();
        DefaultTableModel tableModel = (DefaultTableModel) TabelaConsultaCamisetas.getModel();
        tableModel.setRowCount(0);
        CamisetaController camisetaController = new CamisetaController();
        
        try {
            
            ArrayList<Camiseta> camisetas = camisetaController.listarCamisetas(time);
            camisetas.forEach((Camiseta camiseta) -> {
                tableModel.addRow(new Object[]{camiseta.getEtiquetaCamiseta(),
                                               camiseta.getTime(),
                                               camiseta.getModelo(),
                                               camiseta.getTamanho(),
                                               camiseta.getValor()});
            });
            TabelaConsultaCamisetas.setModel(tableModel);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultaEstoqueCamisetas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaConsultaEstoqueCamisetas().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable TabelaConsultaCamisetas;
