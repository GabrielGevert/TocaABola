...
public class TelaConsultaClientesCadastrados extends javax.swing.JFrame {
    ...
    public TelaConsultaClientesCadastrados() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel.setText("<html>\n<head>\n    <style>\n        /*p2 {\n            text-align: center;\n        }*/\n        man {\n            display: inline-block;\n            align-items: center;\n        }\n    </style>\n</head>\n<body>\n    <div class=\"man\">\n        <tittle>Consulta de cadastro</tittle> <br> <br>\n        <p>Clientes</p>\n    </div>\n</body>\n</html>");
        ...
        PalavraChaveLabel.setText("Informe cpf do cliente: ");
        ...
        TabelaConsultaClientes.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        TabelaConsultaClientes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "Nome", "CPF", "Email", "Telefone", "Newsletter"
            }
        ) {
    ...
    private void BotaoPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoPesquisarActionPerformed
        String cpf = JTFPalavraChave.getText();
        DefaultTableModel tableModel = (DefaultTableModel) TabelaConsultaClientes.getModel();
        ...
        try {
            ...
            clientes.forEach((Cliente cliente) -> {
                tableModel.addRow(new Object[]{cliente.getIdCliente(),
                                               ...
                                               cliente.getEmail(),
                                               cliente.getTelefone(),
                                               cliente.getNewsletter()});
            });
            TabelaConsultaClientes.setModel(tableModel);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultaClientesCadastrados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaConsultaClientesCadastrados().setVisible(true);
            }
        });
    }
