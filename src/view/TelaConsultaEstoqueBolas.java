...
public class TelaConsultaEstoqueBolas extends javax.swing.JFrame {
    ...
    public TelaConsultaEstoqueBolas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        TabelaConsultaBolas = new javax.swing.JTable();
        ...
        PalavraChaveLabel.setText("Informe modelo: ");
        ...
        TabelaConsultaBolas.setFont(new java.awt.Font("Work Sans Medium", 0, 18)); // NOI18N
        TabelaConsultaBolas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Etiqueta", "Modelo", "Marca", "Valor (R$)"
            }
        ) {
        ...
        jScrollPane1.setViewportView(TabelaConsultaBolas);
    ...
    private void BotaoPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoPesquisarActionPerformed
        String modelo = JTFPalavraChave.getText();
        DefaultTableModel tableModel = (DefaultTableModel) TabelaConsultaBolas.getModel();
        tableModel.setRowCount(0);
        BolaController bolaController = new BolaController();
        try {
            ArrayList<Bola> bolas = bolaController.listarBolas(modelo);
            bolas.forEach((Bola bola) -> {
                tableModel.addRow(new Object[] {bola.getEtiquetaBola(),
                                                bola.getModelo(),
                                                bola.getMarca(),
                                                bola.getValor()});
            });
            TabelaConsultaBolas.setModel(tableModel);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultaEstoqueBolas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaConsultaEstoqueBolas().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable TabelaConsultaBolas;
